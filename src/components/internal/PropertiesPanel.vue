...
<template>
  <div>
    <div class="element-properties">
      ...
      >
        <div class="form-group">
          ...
          <div class="input-group mb-3">
            <input
              v-model="selectedField.referencedProperty.name"
              type="text"
              class="form-control"
      ...
      <div
        v-if="selectedField.type === 'table' && selectedField.attribute"
        class="element-property"
      >
        <div class="form-group">
    ...
    >
      <div class="modal-dialog modal-xl">
        <div class="modal-content w-100">
          <div class="modal-header">
            <h1 class="modal-title fs-5" id="entityEditorLabel">Selecionar atributo</h1>
            <button
              type="button"
              class="btn-close"
              data-bs-dismiss="modal"
          ...
          <div class="modal-body">
            <AttributesTable
              :fields="screen.referencedEntity.properties"
              @select-attribute="doSelectAttribute"
            />
          </div>
          <div class="modal-footer">
            <button type="button" class="btn btn-primary" data-bs-dismiss="modal">Fechar</button>
...
function doSelectAttribute(attribute) {
  console.log(attribute)
  props.selectedField.property = attribute.name;
  props.selectedField.referencedProperty = attribute;
